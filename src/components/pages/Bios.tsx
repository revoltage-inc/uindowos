...
import styles from '@style/components/pages/Bios.module.css'
import { TurnOnAnimation } from '@lib/animation/TurnOnAnimation'
import { BiosTextAnimation } from '@lib/animation/BiosTextAnimation'
import { FlareAnimation } from '@lib/animation/FlareAnimation'
